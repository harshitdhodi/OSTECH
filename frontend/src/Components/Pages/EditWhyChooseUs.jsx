...
const EditWhyChooseUs = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        combinedAlts.forEach((alt) => formData.append('alt', alt));
        combinedImgTitles.forEach((title) => formData.append('imgTitle', title));
    ...
    const handleDeleteInitialPhoto = (e, photoFilename, index) => {
      e.preventDefault();
      axios.delete(`/api/whychooseus/${id}/image/${photoFilename}/${index}`, { withCredentials: true })
        .then(() => {
