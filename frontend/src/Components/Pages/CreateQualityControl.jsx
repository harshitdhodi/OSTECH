...
const handleDeleteImage = (index) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "/api/qualitycontrol/createQualityControl",
        formData,
        {
          headers: {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4">
      <h1 className="text-xl font-bold font-serif text-gray-700 uppercase text-center">Add Quality Control</h1>
      <ToastContainer/>
      <div className="mb-4">
