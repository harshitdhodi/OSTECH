...
const AboutForm = () => {
    ...
    const fetchHeadings = async () => {
        try {
            const response = await axios.get('/api/pageHeading/heading?pageType=aboutcompany', {
    ...
    const saveHeadings = async () => {
        try {
            await axios.put(
                '/api/pageHeading/updateHeading?pageType=aboutcompany',
                {
    ...
    const fetchAboutCompany = async () => {
        try {
            ...
            setLongDescription(mission.longDescription || []);
    ...
    const handleDeleteInitialPhoto = (e, photoFilename, index) => {
        e.preventDefault();
        axios
            .delete(`/api/aboutcompany/image/${photoFilename}/${index}`, {
                withCredentials: true,
            })
            .then((response) => {
