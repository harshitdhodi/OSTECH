...
const { countProducts,getLatestProducts,getAllProductsByPriority
    ,getPopularProducts,GetProductsforGrid, insertProduct, updateProduct,getProductsByCategories, deleteProduct, getAllProducts, getSingleProduct, getCategoryProducts, getSubcategoryProducts, getSubSubcategoryProducts, deletePhotoAndAltText, exportProductsToExcel, importProducts, fetchUrlPriorityFreq, editUrlPriorityFreq, fetchUrlPriorityFreqById, fetchUrlmeta, editUrlmeta, fetchUrlmetaById, downloadCatalogue, viewCatalogue } = require('../controller/product')
...
router.get('/getAllProductsByPriority',
    getAllProductsByPriority)
router.get('/getProductsforGrid',GetProductsforGrid)
router.get('/getLatestProducts',  getLatestProducts)
router.get('/getPopularProducts',  getPopularProducts)
router.get('/getProductsByCategories',  getProductsByCategories)
