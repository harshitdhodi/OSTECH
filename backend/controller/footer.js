...
exports.updateFooter = async (req, res) => {
  const { newsletter,address,officeTime, instagramLink, facebookLink, googleLink, location, phoneNo, phoneNo_2, email, email_2 } = req.body;
