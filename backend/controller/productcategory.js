...
const insertCategory = async (req, res) => {
  ...
  try {
    ...
    const newCategory = new ProductCategory({
      category, alt, photo, slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq
    });
...
const insertSubSubCategory = async (req, res) => {
  ...
  try {
    ...
    subCategory.subSubCategory.push({ category,alt,photo,slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq });
    await categoryDoc.save();
...
const deletecategory = async (req, res) => {
  ...
  try {
    ...
    // Only attempt to delete the photo if it exists
    if (category.photo) {
    ...
    // Find and update all products that reference this category
    ...
    console.error('Delete category error:', error); // Add detailed error logging
