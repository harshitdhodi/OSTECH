...
const insertCategory = async (req, res) => {
  ...
  try {
    ...
    const newCategory = new ServiceCategory({ category,alt,photo,slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq  });
